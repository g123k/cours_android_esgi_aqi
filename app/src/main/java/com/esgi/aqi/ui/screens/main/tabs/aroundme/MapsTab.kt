package com.esgi.aqi.ui.screens.main.tabs.aroundme
...
import com.esgi.aqi.data.network.model.ranking.Station
import com.esgi.aqi.ui.utils.GoogleMapUtils
...
class MapsTab : Fragment(), OnMapReadyCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        maps_tab_search_field_arrow.setOnClickListener {
            ...
            // TODO Afficher une erreur si recherche vide
        ...
        // Appelle en réalité le clic sur la flèche (défini au-dessus)
        ...
        maps_tab_search_zone_button.setOnClickListener {
            ...
            val coordinates =
                map.projection.visibleRegion.latLngBounds.northeast.latitude.toString() + "," + map.projection.visibleRegion.latLngBounds.northeast.longitude.toString() + "," + map.projection.visibleRegion.latLngBounds.southwest.latitude.toString() + "," + map.projection.visibleRegion.latLngBounds.southwest.longitude.toString()

            GlobalScope.launch(Dispatchers.IO) {
                try {
                    val stations =
                        AQIAPI.getInstance().listStationsLocalisation(coordinates).await()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        googleMap.setOnMarkerClickListener { marker ->
            ...
            // TODO Appeler showDetailsCard
            val df = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
            df.parse(data.date)?.time?.let { timestamp ->
